...
namespace Task4
{
    class Program
    {
        ...
        {
            var config = new MapperConfiguration(cfg => cfg.CreateMap<NamespaceA.class1, NamespaceB.class1>());
            NamespaceA.class1 Aclass1 = new NamespaceA.class1
            {
            ...
            Bclass1 = mapper.Map<NamespaceB.class1>(Aclass1);

            Console.WriteLine("Data from NamespaceB: Foo: " + Bclass1.Foo + ", Bar: " + Bclass1.Bar + ", Qux: " + Bclass1.Baz.Qux
